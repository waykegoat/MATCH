...
if __name__ == "__main__":
    ...
    # 1. Явно удаляем возможный старый вебхук [citation:1][citation:8]
    try:
        bot.remove_webhook()
    ...
    try:
        ...
        # Логируем ошибку, но не пытаемся перезапускаться бесконечно,
        # так как это может создать новые конфликтующие процессы.
